...
public class ExtractAllTheTextsFromPDFOCREnhanced {
    ...
    public static class PdfTask implements Callable<Void> {
        ...
        private void processOCROnExtractedImages(String imageFolderPath) {
            ...
            for (File imageFile : imageFiles) {
                ...
                // Generate preprocessed image path in the same directory as the source image
                String preprocessedImagePath = imageFile.getParent() + File.separator + "preprocessed_" + imageFile.getName();
                
                // Preprocess the image
                preprocessImage(imageFile.getAbsolutePath(), preprocessedImagePath);

                // Extract text from the preprocessed image and print
